...
1. **Interactive Requirements Refinement** - Codex analyzes rough ideas and enhances them through dialogue
...
| `/build-team` | Create a project-tailored agent team (lead + specialists) | `/build-team` |
| `/team-lead` | Run the agent team (autonomous or directed) — generated by `/build-team` | `/team-lead "fix flaky CI"` |
...
| `.agents/skills/` | Bootstrap skills (start, ideate, init-project) |
...
3. Skills are in `.agents/skills/*/SKILL.md`
...
4. Codex enhances requirements through dialogue
